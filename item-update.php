...
<head>
    ...
    <title>CB | Actualizar Servicio</title>
							...
							<div class="row">
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[0-9()+]{1,10}" class="form-control" name="serv_total" id="serv_total" maxlength="10" required>
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="serv_abono" class="bmd-label-floating">Abono</label>
										<input type="text" pattern="[0-9()+]{1,10}" class="form-control" name="serv_abono" id="serv_abono" maxlength="10" required>
									</div>
								</div>
							</div>
						</div>
